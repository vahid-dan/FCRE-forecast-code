...
# file.copy(file.path(config$file_path$data_directory,config_obs$sss_fname), file.path(config_obs$qaqc_data_location,basename(config_obs$sss_fname)))
#
# if(!is.null(config_obs$specified_sss_inflow_file)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_sss_inflow_file), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_sss_inflow_file)))
# }
# if(!is.null(config_obs$specified_sss_outflow_file)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_sss_outflow_file), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_sss_outflow_file)))
# }
# if(!is.null(config_obs$specified_metfile)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_metfile), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_metfile)))
# }
#
# if(!is.null(config_obs$specified_inflow1)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_inflow1), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_inflow1)))
# }
#
# if(!is.null(config_obs$specified_inflow2)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_inflow2), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_inflow2)))
# }
#
# if(!is.null(config_obs$specified_outflow1)){
#   file.copy(file.path(config$file_path$data_directory,config_obs$specified_outflow1), file.path(config_flare$file_path$qaqc_data_directory,basename(config_obs$specified_outflow1)))
# }
#
